import { Attribute, AttributeConstraint, KeyTypeConstraints } from "@/app/models/attributes"
import { Relationship, RelationshipDestination, Scheme, Table } from "@/app/models/scheme"
import { DependencyMatrix } from "@/libs/relational/dependency_matrix"
...
export class Normalizer {
    ...
    SecondNormalForm(this: Normalizer): [Optional<Scheme>, NormalFormViolation[]] {
        ...
        this.scheme.tables.forEach(entity => {
            const [tables, relationships] = this.TurnTableToSecondNormalForm(entity, new DependencyMatrix(entity.dependencies))
